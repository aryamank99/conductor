# Project: <name> — Conductor host

@conductor-core.md

## Project facts (Conductor host contract)
- **Stack & conventions:** <language, framework, test framework, test file layout — e.g. "Next.js 15 + React 19, plain JS (no TypeScript). Tests: vitest, co-located as `lib/<name>.test.js`">
